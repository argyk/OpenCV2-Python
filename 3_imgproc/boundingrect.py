...
cv2.imshow('input gray and blurred', blur)

cv2.namedWindow('input colour')


thresh = 100
max_thresh = 255

cv2.createTrackbar('canny thresh:','input colour',thresh,max_thresh,thresh_callback) # this creates the trackbar to configure the threshold
